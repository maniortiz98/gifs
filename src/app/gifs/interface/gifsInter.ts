// To parse this data:
//
//   import { Convert, SearchGirfs } from "./file";
//
//   const searchGirfs = Convert.toSearchGirfs(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGirfs {
    data:       Gif[];
...
export class Convert {
    public static toSearchGirfs(json: string): SearchGirfs {
        return cast(JSON.parse(json), r("SearchGirfs"));
    }

    public static searchGirfsToJson(value: SearchGirfs): string {
        return JSON.stringify(uncast(value, r("SearchGirfs")), null, 2);
    }
}
